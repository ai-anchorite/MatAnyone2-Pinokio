...
2. Click the install badge above, or search "MatAnyone2-Pinokio" in the Pinokio app
...
<details>
<summary><strong>Original Project README</strong> <em>(click to expand)</em></summary>
...
<div style="width: 100%; text-align: center; margin:auto;">
    <img style="width:100%" src="app/assets/teaser.jpg">
</div>
...
## 🔎 Overview
![overall_structure](app/assets/matanyone1vs2.jpg)
...
![overall_teaser](app/assets/teaser_demo.gif)

## 📊 Evaluation
Please refer to the [evaluation documentation](app/docs/EVAL.md) for details.

## 🛠️ Data Pipeline
![data_pipeline](app/assets/data_pipeline.jpg)
